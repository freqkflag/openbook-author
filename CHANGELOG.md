...
- **Wave B + Wave C ship** ([c8caf32](https://github.com/freqkflag/openbook-author/commit/c8caf32)) — FOSS differentiation + experimental pilots on `main`:
  - **Wave B (7/7):** hierarchical TOC/parts ([#49](https://github.com/freqkflag/openbook-author/issues/49)); IBA import depth + diagnostics ([#19](https://github.com/freqkflag/openbook-author/issues/19)); git-for-books folder mode + Git panel ([#59](https://github.com/freqkflag/openbook-author/issues/59)); AI RAG consistency pass ([#60](https://github.com/freqkflag/openbook-author/issues/60)); Ollama model presets + offline badge ([#61](https://github.com/freqkflag/openbook-author/issues/61)); EPUB 3.3 + accessibility metadata ([#62](https://github.com/freqkflag/openbook-author/issues/62)); optional self-hosted backup — WebDAV + S3 ([#63](https://github.com/freqkflag/openbook-author/issues/63))
  - **Wave C (7/7):** fixed-layout canvas MVP ([#20](https://github.com/freqkflag/openbook-author/issues/20)); media + quiz widgets ([#17](https://github.com/freqkflag/openbook-author/issues/17), [#15](https://github.com/freqkflag/openbook-author/issues/15)); Typst PDF pilot — Electron ([#64](https://github.com/freqkflag/openbook-author/issues/64)); Yjs collab prototype ([#22](https://github.com/freqkflag/openbook-author/issues/22)); plugin SDK preview ([#65](https://github.com/freqkflag/openbook-author/issues/65)); W3C audiobook manifest export ([#66](https://github.com/freqkflag/openbook-author/issues/66)); markdown authoring mode ([#67](https://github.com/freqkflag/openbook-author/issues/67))
  - Tracking: [WAVE-B-STATUS.md](docs/WAVE-B-STATUS.md), [WAVE-C-STATUS.md](docs/WAVE-C-STATUS.md); ADRs 0005–0009 accepted
